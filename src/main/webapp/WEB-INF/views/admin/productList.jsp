<%@ page import="com.FanXuyang.dao.IcategoryDao" %>
<%@ page import="com.FanXuyang.dao.CategoryDao" %>
...
<section id="cart_items">
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<c:forEach var="p" items="${productList}">
						...
						<%
							com.FanXuyang.model.Product p = (com.FanXuyang.model.Product) pageContext.findAttribute("p");
							int pid = p.getCategoryId();
							java.sql.Connection con = (java.sql.Connection) application.getAttribute("con");
							CategoryDao categoryDao = new CategoryDao();
							String catName = categoryDao.findByCategoryId(con, pid);
						%>
