			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="orderList">
						...
						<td>${o.orderDate}</td>
						<%
							com.FanXuyang.model.Order o=(com.FanXuyang.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.FanXuyang.dao.UserDao userDao=new com.FanXuyang.dao.UserDao();
							String customerName=userDao.findById(con, userId).getName();
							 %>
						 <td><%=customerName %></td>
						<td>
						...
						<%
							...
							String paymentType=com.FanXuyang.model.Payment.findByPaymentId(con,n);
							 %>
